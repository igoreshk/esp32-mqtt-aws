...
void loop() {
   ...
   sprintf(payload,"{\"sensor_id\":\"1234567890\",\"edge_id\":\"1234567890\",\"opened\":1,\"check_time\":\"2020-10-11T22:45:17.12722Z\",\"battery_level\":45}", switchStatus); // Create the payload for publishing
